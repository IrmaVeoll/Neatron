  ...
  public class SampleNetwork
    {
        ...
        public SampleNetwork(int numInput, int numHidden, int numOutput)
        {
            _numInput = numInput;
        ...
        public float[] Train(float[][] trainData, float learnRate, int maxEpochs = 1, float momentum = 0.0f)
        {
            ...
            var oSignals = new float[_numOutput];                  // local gradient output signals - gradients w/o associated input terms
